...
params = {
    ...
    'omega_f': 1,
    'g': 1,
    'u': np.array([0,0,1], dtype=np.complex128),
    'v': np.array([1,0,0], dtype=np.complex128),
...
params = {
    ...
    'omega_f': 1,
    'g': 1,
    'u': np.array([0,1,0], dtype=np.complex128),
    'v': np.array([0,-np.cos(delta),np.sin(delta)], dtype=np.complex128),
    'm': np.array([1,0,0], dtype=np.complex128),
    't': None,
    'tau': 0,
    'gamma': 0,
