...
def prepare_params(omega_as, taus):
    ...
    omega_as_array = omega_as_array.reshape((1,-1)) if omega_as_array.ndim == 1 else omega_as_array
...
def calculate_wvs(u, v, m, omega_as, t, taus, gamma=0, m_to_int=True, a=0, b=1):
